<html>
<head>
<title>Adicionar Nova Espressão Bloqueada</title>
...
include_once('../includes/files.inc.php');
	...
	echo "<p class='titulo'>Para Adicionar expressões bloqueadas, utilize o campo abaixo:</p>";
...
echo '<table class="tabela">';
	...
	echo '<td><b>Lista de expressões Bloqueados</b></td>';

//NOVO METODO PARA CONTAR    
$arquivo = "$PL_Bloqueadas";
