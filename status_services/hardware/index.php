<meta http-equiv="refresh" coment="3; URL=index.php" >
<?php 
...
//  } 
  ...
  $tpl->set_var('title', $text['title'] . ' ' . $XPath->getData('/phpsysinfo/Vitals/Hostname') . ' IP: ' . $XPath->getData('/phpsysinfo/Vitals/IPAddr') . '');
