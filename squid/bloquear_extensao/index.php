...
include_once('../includes/files.inc.php');
	...
	echo "<p class='titulo'>Para Adicionar extensões bloqueadas, utilize o campo abaixo:</p>";
	echo "<input class='input' type='text' width='400' name='regra' value='' /> ";
...
echo '<table class="tabela">';
	...
	echo '<td><b>Lista de extensões Bloqueadas</b></td>';
